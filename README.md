...
Each chapter is self-contained and ships standalone, runnable examples under `examples/NN-slug/`. Run any example directly with `bun run`. See [OUTLINE.md](OUTLINE.md) for the full chapter plan.
